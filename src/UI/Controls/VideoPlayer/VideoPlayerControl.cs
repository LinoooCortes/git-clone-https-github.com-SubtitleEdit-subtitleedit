...
namespace Nikse.SubtitleEdit.Controls.VideoPlayer
{
    public class VideoPlayerControl : UserControl
    {
        ...
        /// <summary>
        /// Overlay layer that renders positioned subtitle text on top of the video frame.
        /// Defaults to <see cref="NullSubtitleOverlay"/>; swap in a real implementation
        /// when WYSIWYG overlay rendering is introduced.
        /// </summary>
        public ISubtitleOverlay SubtitleOverlay { get; set; } = new NullSubtitleOverlay();
