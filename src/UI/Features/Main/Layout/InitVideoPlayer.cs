...
public static class InitVideoPlayer
{
    ...
    public static Grid MakeLayoutVideoPlayer(MainViewModel vm, out VideoPlayerControl videoPlayerControl)
    {
        ...
        // Wire the subtitle overlay hook so ISubtitleOverlay.SetSubtitles is called
        // on every position-changed tick.  NullSubtitleOverlay is the default, so
        // this is a no-op until a real overlay implementation is swapped in.
        vm.InitializePositioningOverlay();
